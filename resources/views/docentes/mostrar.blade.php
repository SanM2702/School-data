...
@section('title', 'Mostrar Docentes - Colegio')
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="main-content p-4">
                <h1 class="mb-4">{{ $docente->persona->primerNombre }} {{ $docente->persona->segundoNombre }} {{ $docente->persona->primerApellido }} {{ $docente->persona->segundoApellido }}</h1>
                ...
                <div class="row g-4 align-items-stretch">
                    ...
                    <div class="col-md-8 d-flex">
                        <div class="card w-100 h-100">
                            <div class="card-body">
                                <h5 class="card-title mb-3">Información del Docente</h5>
                                <div class="row gy-2">
                                    <div class="col-sm-6"><strong>Documento:</strong> {{ $docente->persona->noDocumento }}</div>
                                    <div class="col-sm-6"><strong>Teléfono:</strong> {{ $docente->persona->telefono }}</div>
                                    <div class="col-sm-6"><strong>Email:</strong> {{ $docente->persona->email }}</div>
                                    <div class="col-sm-6"><strong>Área:</strong> {{ $docente->area ?? '-' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
